function sendEmail(e) {
  ...
  //send card and function
  const action = CardService.newAction().setFunctionName('sendTheEmail')
  ...
  const fixedFooter = CardService.newFixedFooter()
   ...
   const subject = CardService.newTextInput()
                ...
                .setValue('Patient Letter | Private and Confidential');
  ...
  const emailContent = CardService.newTextInput()
                ...
                .setValue('To whom it may concern,\n\nPlease see attached report regarding a mutual patient.\n\nIf you have any queries, please do not hesitate to get in touch.\n\nAll the best\n' + userName);
